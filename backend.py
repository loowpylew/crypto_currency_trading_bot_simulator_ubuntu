...
def printCurrentState(open_, close_, simple_Moving_Average, standard_deviation, bollinger_bands, percentage_Increase): 
...
def analyze(pair, since, PRICE_THRESHOLD, STOP_LOSS, api, loop_cycle): 
    ...
    if  open_ > simple_Moving_Average and sms.calcBollingerBands(data, pair[0], pair[1]) == 1: 
        print("[open_ > simple_Moving_Average")
        print(" Previous close > lowerbound < mean]  \n")
        sell_On_Increase(pair, since, api, open_, close_, loop_cycle, simple_Moving_Average, price_difference, percentage_Increase, percentage_threshold_equivilant, standard_deviation, bollinger_bands, PRICE_THRESHOLD, available_money, available_crypto, last_trade)
    elif open_ < simple_Moving_Average and sms.calcBollingerBands(data, pair[0], pair[1]) == 0:
        print("[open_ < simple_Moving_Average")
        print(" Previous < than upperbound > mean] \n")
        buy_On_Decrease(pair, since, api, open_, close_, loop_cycle, simple_Moving_Average, price_difference, percentage_Increase, percentage_Decrease, percentage_stop_loss_equivilant, standard_deviation, bollinger_bands, STOP_LOSS, available_money, available_crypto, last_trade)
    elif open_ < simple_Moving_Average and sms.calcBollingerBands(data, pair[0], pair[1]) == 1:
        print("[open_ < simple_Moving_Average")
        print(" Previous close > lowerbound < mean] \n")
        combinational_buy_sell(pair, since, api, open_, close_, loop_cycle, simple_Moving_Average, price_difference, percentage_Increase, percentage_Decrease, percentage_threshold_equivilant, percentage_stop_loss_equivilant, standard_deviation, bollinger_bands, PRICE_THRESHOLD, STOP_LOSS, available_money, available_crypto, last_trade)   
    elif open_ > simple_Moving_Average and sms.calcBollingerBands(data, pair[0], pair[1]) == 0:
        print("[open_ > simple_Moving_Average")
        print(" Previous < than upperbound > mean]  \n")
        combinational_buy_sell(pair, since, api, open_, close_, loop_cycle, simple_Moving_Average, price_difference, percentage_Increase, percentage_Decrease, percentage_threshold_equivilant, percentage_stop_loss_equivilant, standard_deviation, bollinger_bands, PRICE_THRESHOLD, STOP_LOSS, available_money, available_crypto, last_trade)
    ...
    elif open_ == simple_Moving_Average and open_ == close_:
        print("[Simple_Moving_Average == open")
        print(" open_ == previous close")
        print(" No change in price since previous anaylsis]")
        printCurrentState(open_, close_, simple_Moving_Average, standard_deviation, bollinger_bands, percentage_Increase)
    elif open_ == simple_Moving_Average and open_ != close_:
        print("[Simple_Moving_Average == open")
        print(" Open != close]") 
        combinational_buy_sell()
    elif open_ != simple_Moving_Average and open_ == close_: 
        print("[Simple_Moving_Average != open")
        print(" Open == close]")
        print(" No change in price since previous anaylsis]")
...
def sell_On_Increase(pair, since, api, open_, close_, loop_cycle, simple_Moving_Average, price_difference, percentage_Increase, percentage_threshold_equivilant, standard_deviation, bollinger_bands, PRICE_THRESHOLD, available_money, available_crypto, last_trade):
...
def buy_On_Decrease(pair, since, api, open_, close_, loop_cycle, simple_Moving_Average, price_difference, percentage_Increase, percentage_Decrease, percentage_stop_loss_equivilant, standard_deviation, bollinger_bands, STOP_LOSS, available_money, available_crypto, last_trade):
